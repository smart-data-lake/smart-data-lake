...
### Continuous change
Data Mesh embraces continuous change in you Data Products. 
...
While many of these concepts for a federated governance are on an organizational level, not on a technical level, 
...
*SDLB* now has support for encrypted columns that help i.e. with PII data (Personally Identifiable Information).
