...
TODO: what happens to output Data Objects?
...
TODO not clear to me
On execution every Action takes the partition values of the main input and filters them again for every output DataObject by its defined partition columns, 
which serve again as partition values for the input of the next Action.
