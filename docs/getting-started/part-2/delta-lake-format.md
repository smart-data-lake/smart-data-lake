...
To do so you need to add additional files to the project. Change to the projects root directory and **unzip part2.additional-files.zip**, then run the following commands in the projects root directory:
