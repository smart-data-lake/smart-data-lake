...
```
Now let us check [UI](https://ui-demo.smartdatalake.ch/#/config/dataObjects/ext-departures), where the given information in metadata are visualized for `ext-departures`.
:::
