 ...
 * @param actionCatalogFactory     A method to create a action catalog instance to be used by this SmartDataLakeBuilderLab.
 *                                 Note that this is normally an instance from a class generated by LabCatalogGenerator in a second compile phase.
...
case class SmartDataLakeBuilderLab[D,A](
                                       ...
                                       private val hadoopConf: Option[Configuration] = None
                                       ) {

  @transient val (registry, globalConfig) = ConfigToolbox.loadAndParseConfig(configuration, userClassLoader, hadoopConf.getOrElse(new Configuration()))
