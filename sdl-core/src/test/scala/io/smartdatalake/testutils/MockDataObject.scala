 ...
 */
case class MockDataObject(override val id: DataObjectId, override val partitions: Seq[String] = Seq(), override val schemaMin: Option[GenericSchema] = None, primaryKey: Option[Seq[String]] = None, tableName: String = "mock") extends DataObject with CanHandlePartitions with TransactionalTableDataObject {
