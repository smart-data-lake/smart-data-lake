 ...
 */
case class RemoteAction(override val id: ActionId,
  ...
  override def factory: FromConfigFactory[Action] = RemoteAction
...
object RemoteAction extends FromConfigFactory[Action] {
  override def fromConfig(config: Config)(implicit instanceRegistry: InstanceRegistry): RemoteAction = {
    extract[RemoteAction](config)
  }
}
