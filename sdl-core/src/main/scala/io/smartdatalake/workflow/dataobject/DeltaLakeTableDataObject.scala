 ...
 *
 * The engine-specific implementation (e.g. classic Spark or Spark Connect) is discovered on the classpath,
 * see [[DeltaLakeTableEngine]]. Add module sdl-deltalake for classic Spark, or sdl-sparkconnect for Spark Connect.
 *
 ...
 * @param connectionId optional id of [[io.smartdatalake.workflow.connection.DeltaLakeTableConnection]]
