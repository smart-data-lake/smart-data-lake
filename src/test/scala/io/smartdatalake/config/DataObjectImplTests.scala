...
import io.smartdatalake.definitions.{DateColumnType, UserPassAuthMode}
...
class DataObjectImplTests extends FlatSpec with Matchers {
  ...
  "SplunkDataObject" should "be parsable" in {
    ...
    registry2.register(SplunkConnection("con123","test.host", 8080, UserPassAuthMode("CLEAR#testuser", "CLEAR#secret")))
